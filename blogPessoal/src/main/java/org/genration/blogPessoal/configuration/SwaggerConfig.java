package org.genration.blogPessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("org.genration.blogPessoal.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/DaniloDaSilv")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Danilo da Silva", "https://github.com/DaniloDaSilv", "danilodasilvadisanto@gmail.com");
	}
